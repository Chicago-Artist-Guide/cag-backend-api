...
@Service
public class ProfileServiceExtraInfo implements ProfileServiceI {
    private final ProfileDao profileDao;

    @Autowired
    public ProfileServiceExtraInfo(ProfileDao profileDao){
    ...
    public void registerProfileExtraInfo(String userId, ProfileRegistrationExtraInfoDto profileRegistrationExtraInfoDto) {
    }
}
